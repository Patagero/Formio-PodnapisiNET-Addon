...
// 🔒 Prijava (s piškotki + ponovna uporaba)
async function ensureLoggedIn(page) {
  ...
  try {
    ...
    throw new Error("⚠️ Polje za uporabniško ime se ni pojavilo – morda Cloudflare ali CAPTCHA.");
  }
...
// 🔍 Iskanje z networkidle2 + regex fallback
